    ...
    <div className='space-y-20 pb-30'>
        ...
        <div className='flex flex-col md:flex-row justify-between'>
            ...
            <div className='flex w-full'>
                ...
                <div className='flex-grow '>{/* p-3 */}
                   <img src={bespoke} alt="" className='w-full h-[700px] object-center'/> 
                </div>
            </div>
            <div className='w-full space-y-9 mx-2 p-3'>
                ...
                <div className='space-y-3 flex flex-col'>
                    ...
                    <div className='flex gap-5'>
                         <input type="button" value="XS" className='w-[40px] h-[40px] bg-red-400 rounded-2xl text-[14px] font-medium'/>  
                         <input type="button" value="SM" className='w-[40px] h-[40px] bg-red-400 rounded-2xl text-[14px] font-medium'/>  
                         <input type="button" value="LG" className='w-[40px] h-[40px] bg-red-400 rounded-2xl text-[14px] font-medium'/>  
                         <input type="button" value="L" className='w-[40px] h-[40px] bg-red-400 rounded-2xl text-[14px] font-medium'/>  
                    </div>
                </div>
                <div>
                ...
                <div className='flex gap-6'>
                    <button type="button" className='py-3 px-18 rounded bg-[#E6B566]'>Buy(34,000000000000000)</button>
                    <button type="button" className='py-3 px-14 rounded bg-[#E6B566] flex'><FiShoppingCart  size={19} className='pt-1'/> <span className='pl-2'>Add to cart</span></button>
        ...
        <div className='px-10 space-y-4'>
            <span className='flex items-center gap-3'>
                ...
                <h3 className='text-[34px] font-semibold'>Product Description</h3>
        ...
        <div className='px-10 space-y-4'>
            <span className='flex items-center gap-3'>
                <div className='h-[30px] w-[6px] bg-red-300 rounded'></div>
                <h3 className='text-[34px] font-semibold'>Similar Products</h3>
            </span>
